  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-white/[0.05] mb-8">
      ...
      <div className="flex items-center gap-2">
        <button 
          onClick={onBotToggle}
          className="group relative h-9 px-4 flex items-center justify-center gap-2 border border-white/10 hover:border-primary/50 bg-white/[0.02] hover:bg-white/[0.05] text-white/60 hover:text-white transition-all duration-300 cursor-pointer overflow-hidden text-xs font-semibold tracking-wider uppercase"
        >
